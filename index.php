...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo base_url(); ?>/assets/img/teste.ico">
...
<body>
    <div class="wrapper">
        <div class="sidebar" data-image="<?php echo base_url(); ?>/assets/img/sidebar-3.jpg" data-color='black'>
            <!--
            ...
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    <li class="nav-item active">
                        <a class="nav-link" href='/agenda/index.php/contatos'>
                    ...
                    <li>
                    <li class="nav-item active">
                        <a class="nav-link" href='/agenda/index.php/contatos/novo'>
                ...
                <div class="container-fluid">
                    <nav>
                        ...
                        <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ"> © </a>
                            ...
                            made by 
                            <a href="http://www.facebook.com/pete.vdlk">Lucas Pete</a>
                        </p>
                    </nav>
                </div>
            </footer>
